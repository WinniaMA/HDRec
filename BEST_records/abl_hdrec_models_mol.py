...
class GAMENet(nn.Module):
    def __init__(self, vocab_size, ehr_adj, ddi_adj, MPNNSet, N_fingerprints, average_projection, substruct_num,substruct_para, substruct_dim=64,emb_dim=64, device=torch.device('cpu:0'), ddi_in_memory=True):
        ...
        self.ehr_gcn = GCN(voc_size=vocab_size[2], emb_dim=emb_dim, adj=ehr_adj,node_features = None, device=device)
        self.ddi_gcn = GCN(voc_size=vocab_size[2], emb_dim=emb_dim, adj=ddi_adj,node_features = None, device=device)
