...
from get_node_feeatures import graph_batch_from_smile_molerec
from models_zw import GAMENet
...
def main():
    ...
    data_path = '../data_molerec/records_final.pkl'
    voc_path = '../data_molerec/voc_final.pkl'

    ehr_adj_path = '../data_molerec/ehr_adj_final.pkl'
    ddi_adj_path = '../data_molerec/ddi_A_final.pkl'
    node_features_path = '../data_molerec/node_features.pkl'
    substruct_smile_path = '../data_molerec/substructure_smiles.pkl'
    device = torch.device('cuda:0')

    ddi_mask_path = '../data_molerec/ddi_mask_H.pkl'  # sub_structure_module

    molecule_path = r"F:\MzwCode\GAMENet_Original\data_molerec\idx2SMILES.pkl"
    ...
    substruct_para = {
        ...
        'drop_ratio': 0.8, 'gnn_type': 'gin', 'virtual_node': False
    }
